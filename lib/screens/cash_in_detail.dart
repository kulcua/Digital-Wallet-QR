...
class CashInDetail extends StatefulWidget {

  final CardModel cardModel;
  final User user;
  CashInDetail({this.cardModel, this.user});

  @override
  _CashInDetailState createState() => _CashInDetailState();
}

class _CashInDetailState extends State<CashInDetail> {
  int money;
